...
cov_center_main_rebar = nom_cover_main_rebar+((n_mt_row/2)*main_ten_rebar_dia)+(((n_mt_row-1)/2)*main_ten_rebar_dia)
...
main_ten_force =(n_force*(sec_height/2+eccen-cov_sec_rebar))/(sec_height-cov_center_main_rebar-cov_sec_rebar)
...
sec_ten_force =(n_force*(sec_height/2-eccen-cov_center_main_rebar))/(sec_height-cov_center_main_rebar-cov_sec_rebar)
...
a_symm =(2*sec_breadth*cov_center_main_rebar)/tot_main_ten_rebar
# crack width in mm
# 1 N/mm2 = 0.145 KSI (Kilo pound force per square inch)
# 1 in3 = 16387 mm3
crack_width = (0.1*main_ten_Stress_rebar*0.145*((cov_center_main_rebar*a_symm/16387)**(1/3))/1000)*25.4
